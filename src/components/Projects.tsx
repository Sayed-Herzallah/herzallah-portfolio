          ...
          {portfolioData.projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                {/* Description */}
                <p className="text-sm text-gray-400 mb-6 leading-relaxed flex-grow line-clamp-3">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-1.5 mb-6">
                  {project.tags.slice(0, 3).map((tag) => (
                    <span
                      key={tag}
                      className="text-[11px] font-medium text-gray-400 bg-white/[0.03] border border-white/[0.06] px-2 py-0.5 rounded-md"
                    >
                      {tag}
                    </span>
                  ))}
                  {project.tags.length > 3 && (
                    <span className="text-[11px] font-medium text-primary bg-primary/5 border border-primary/10 px-2 py-0.5 rounded-md">
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-white/5">
                  ...
                  <button
                    ...
                    className="ml-auto inline-flex items-center gap-1.5 text-xs font-semibold text-primary hover:text-white transition-colors cursor-pointer"
                  >
              ...
              >
                ...
                >
                  ...
                  <div className="overflow-y-auto flex-grow scrollbar-none">
                    ...
                    <div className="relative aspect-video w-full bg-zinc-950 border-b border-white/[0.06] overflow-hidden group/modal-img">
                      ...
                      {imagesList.length > 1 && (
                        <>
                          <button
                            ...
                            className="absolute left-4 top-1/2 -translate-y-1/2 p-2.5 rounded-full bg-black/60 border border-white/10 hover:bg-black/80 text-white transition-all cursor-pointer z-30 opacity-100 md:opacity-0 md:group-hover/modal-img:opacity-100 duration-200 shadow-md"
                          ...
                          <button
                            ...
                            className="absolute right-4 top-1/2 -translate-y-1/2 p-2.5 rounded-full bg-black/60 border border-white/10 hover:bg-black/80 text-white transition-all cursor-pointer z-30 opacity-100 md:opacity-0 md:group-hover/modal-img:opacity-100 duration-200 shadow-md"
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedProject.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-xs font-medium text-gray-300 bg-white/[0.04] border border-white/[0.08] px-3 py-1.5 rounded-md"
                            >
                              {tag}
                            </span>
                          ))}
