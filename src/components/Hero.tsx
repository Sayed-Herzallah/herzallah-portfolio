...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden">
      ...
      {/* Desktop-only profile background logic - DECOUPLED to a clean 2-column grid to avoid any overlaps */}
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-20 grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-y-12 items-center min-h-[85vh] lg:min-h-[90vh]">
        ...
        {/* Left Column (lg:col-span-6) - All texts strictly contained on the left half */}
        <motion.div
          initial={{ opacity: 0, x: -30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.4 }}
          className="col-span-1 lg:col-span-6 flex flex-col items-center lg:items-start justify-center text-center lg:text-left pt-6 lg:pt-0 z-20"
        >
        ...
        {/* Right Column (lg:col-span-6) - Portrait strictly contained on the right half, no overlaps */}
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.4 }}
          className="col-span-1 lg:col-span-6 flex justify-center items-center relative my-4 w-full max-w-[420px] xs:max-w-[460px] sm:max-w-xl md:max-w-2xl lg:max-w-full mx-auto z-10"
        >
